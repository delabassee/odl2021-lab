...
💡 Do notice that a record compact constructor doesn't take any parameters as they are already known and fixed, i.e. it's simply the record components, the record state. 
